...
/**
* \brief        Tính toán nhịp tim và nồng độ oxi trong máu
* \par          Details
*               Bằng cách tính toán đỉnh của chu kỳ PPG và liên hệ với AC/DC của đèn LED đỏ/hồng ngoại, tính toán được tỷ số xy của SpO2
*
